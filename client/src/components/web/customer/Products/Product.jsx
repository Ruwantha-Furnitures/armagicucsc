...
const Product = () => {
  ...
  const getSelectedCategoryID = async (categoryID) => {
    ...
    const typeResponse = await axios.get(`/api/typeforcategory/${category_id}`);
                    ...
                    <Form inline>
                      <Row>
                        <select
                          ...
                          value={category}
                          onChange={(e) =>
                            getSelectedCategoryID(e.target.value)
                          }
                        >
            ...
            <Card.Body>
              ...
              <center>
                ...
                <div className={CommnStyles.gridContainer}>
                  ...
                  {isFiltered === true &&
                    Array.isArray(selectedProducts) === true && (
                      <>
                        {selectedProducts.map((selectedproductList) => (
                          <Container fluid>
                            <Card style={{ width: "18rem" }}>
                              <center>
                                <img
                                  src={selectedproductList.img_location}
                                  alt="items"
                                  style={funitureimg}
                                  width={200}
                                  height={150}
                              ...
                              <center>
                                <Link to="/viewProduct">
                                  <button
                                    class="addtocart"
                                    onClick={() =>
                                      sayHello(selectedproductList.id)
                                    }
                                  >
                                    Read More
                                  </button>
