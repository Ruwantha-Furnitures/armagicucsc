...
function CartDetails() {
  ...
  useEffect(() => {
    ...
    localStorage.setItem("afterDiscount", 0.0);
  ...
  const removeData = (id) => {
    axios.delete(`/api/customerCart/id/${id}`).then((res) => {
                  ...
                  <Form style={{ padding: "20px" }}>
                    <Row sm={12} style={rowStyle}>
                      <Col sm={12}>
                        ...
                        <Table
                          responsive="sm"
                          class="table table-hover table-bordered p-5"
                        >
                          <thead>
                            <tr>
                              <th>#</th>
                            ...
                            {cartData.map((productList, i) => (
                              <tr key={i}>
                                ...
                                <td>
                                  ...
                                  <button
                                    class="btn btn-light"
                                    onClick={() => removeData(productList.id)}
                                  >
