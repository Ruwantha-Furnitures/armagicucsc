  ...
  const getDeliveryCharge = async () => {
    ...
    try {
      const res = await axios.get(
        `/api/deliverychargefordistrict/area/${area}`
          ...
          <Col sm={8}>
            <Card style={{ marginBottom: "20px" }}>
              <Form style={{ padding: "20px" }}>
                <Row style={rowStyle}>
                  <center>
                    <img src={Avatar} alt={Avatar} width={50} height={50}></img>
                  </center>
                  <center>
                    <h2 style={title}>Shipping Details</h2>
                  </center>
                </Row>
            ...
            <Card style={{ padding: "20px" }}>
              ...
              <Row sm={12}>
                ...
                <Col sm={6}>
                  <Form.Label>
                    Rs.{" "}
                    {parseFloat(localStorage.getItem("cartTotal")).toFixed(2)}
                  </Form.Label>
                </Col>
              </Row>
              <Row sm={12}>
                ...
                <Col sm={6}>
                  <Form.Label>
                    Rs. {localStorage.getItem("afterDiscount")}
                  </Form.Label>
                </Col>
              </Row>
              <Row sm={12}>
              ...
              <br />
              <center>
                <button onClick={checkout} className={CommonStyle.paybtn}>
                  Pay with Payhere
                </button>
              </center>
            </Card>
